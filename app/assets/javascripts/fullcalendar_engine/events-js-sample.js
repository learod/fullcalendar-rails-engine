  ...
  Form: {
    ...
    fetch: function(options){
      $.ajax({
        ...
        error: function(err){ console.log("error, but hacking through: "); eval(err); FullcalendarEngine.Form.render(options) }
      });
    },
